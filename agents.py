...
from tools import computational_tools, search_tools
...
class VeritasAgents:
    ...
    def computational_scientist_agent(self) -> Agent:
        ...
        return Agent(
            ...
            goal=(
                "使用提供的工具（FileReadTool和LocalCodeExecutor）讀取數據文件，"
            ...
            backstory=(
                ...
                "matplotlib和seaborn在圖表輸入的時候一定用英文"
                "用英文讓圖表的字體能夠輸出"
                "可視化圖表要可以表現出數據集的特性，資料的結構，在相對應的領域所需要的圖表"
                ...
                "當需要執行代碼時，你會使用LocalCodeExecutor，它能在本地環境中可靠地執行代碼，"
                "支援所有已安裝的Python函式庫，包括matplotlib、seaborn等可視化工具。"
            ),
