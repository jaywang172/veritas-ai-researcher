...
def test_simple_workflow():
    ...
    try:
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write(f"# NVIDIA Business Model Analysis Test\n")
            f.write(f"# Generated by Veritas Test Script\n")
            f.write(f"# Goal: {goal}\n")
...
def test_dependencies():
    ...
    required_packages = [
        'fastapi', 'uvicorn', 'crewai', 'langchain_openai', 
        'pandas', 'matplotlib', 'requests', 'dotenv'
    ]
